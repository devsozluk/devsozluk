...
export const TextArea = ({
  ...
  const baseClasess = classNames({
    className: true,
    "w-full mb-4 border-gray-200 rounded-lg bg-gray-700 border-gray-600 border border-transparent transition-all": true,
    "group-focus-within:!border-blue-500": !children,
